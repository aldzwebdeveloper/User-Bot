...
class BTN:
    ...
    def PROMODEK(message):
        button = [
            [InlineKeyboardButton("「 ✅ Setuju & Lanjutkan 」", url="http://t.me/KIELHOSTING1?text=Bang+Mau+Beli+Reseller+Ubot+Kirim+Qris+Atau+Dana")],
        ]
        return button

    def ALWAYSBOYSZ(message):
        button = [
            [InlineKeyboardButton("room public", url="https://t.me/murbandprivkielhosting")],
        ]
        return button
    ...
    def START(message):
        if not message.from_user.id == OWNER_ID:
            button = [
                ...
                [
                    InlineKeyboardButton("✭ ʀᴏᴏᴍ ᴘᴜʙʟɪᴄ ✭", url="https://t.me/murbandprivkielhosting"),
                    InlineKeyboardButton("⦪ owner ✭", url="https://t.me/KIELHOSTING1")
                ],
                [
                    InlineKeyboardButton("⦪ ᴀʙᴏᴜᴛ ᴋɪᴇʟ ✭", url="https://t.me/kieltestimoni")
                ],
                [
