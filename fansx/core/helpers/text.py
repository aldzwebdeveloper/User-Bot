...
KIEL USERBOT
<b> 📚💎@{bot.me.username} Adalah bot yang dapat membuat userbot dengan efisien dan cepat. Bot ini dikembangkan oleh <a href=tg://openmessage?user_id={OWNER_ID}>@KIELHOSTING2</a> jika ada kendala atau kesalahan pada bot bisa dm owner bot nya</b></blockquote>
"""
...
OWNER BOT : <a href=tg://openmessage?user_id={OWNER_ID}>@KIELHOSTING2</a> 
...
"""
    ...
    def POLICY():
        return """ <blockquote><b>ᴊɪᴋᴀ ᴀᴅᴀ ᴋᴇɴᴅᴀʟᴀ sɪʟᴀʜᴋᴀɴ ʜᴜʙᴜɴɢɪ  <a href=tg://openmessage?user_id={OWNER_ID}>@KIELHOSTING2</a></b></blockquote>
"""
