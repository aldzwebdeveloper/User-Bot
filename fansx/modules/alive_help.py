...
<blockquote>{bot.me.mention}
    status: {status} 
       {psr} expired_on: {exp} 
        ...
        <blockquote><b>Userbot 5k/bulan by @ubotpremiumkiel_bot</b></blockquote>
"""
...
async def _(client, callback_query):
    ...
    os.execl(sys.executable, sys.executable, "-m", "KIEL PREM")
