...
async def done_command(client, message):
    ...
    try:
        ...
        response = (
            ...
            f"<blockquote>ᴛᴇʀɪᴍᴀᴋᴀsɪʜ ᴛᴇʟᴀʜ ᴏʀᴅᴇʀ</blockquote> userbot by @KIELHOSTING2"
        )
...
async def done_command(client, message):
    ...
    try:
        ...
        response = (
            ...
            f" <blockquote><b> ᴛᴇʀɪᴍᴀᴋᴀsɪʜ ᴛᴇʟᴀʜ ᴏʀᴅᴇʀ ᴅɪ <a href=tg://openmessage?user_id={OWNER_ID}>userbot by @KIELHOSTING2 ✮</a></blockquote"
